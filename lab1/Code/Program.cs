...
class Program
{
	...
	{
		//Product product1 = new ClothingProduct("Shirt", new Money(10, CurrencyType.USD), "A nice shirt", "M", "Cotton");
		//Product product2 = new ClothingProduct("Pants", new Money(20, CurrencyType.USD), "A nice pair of pants", "L", "Denim");
		//Product product3 = new FoodProduct("Apple", new Money(1, CurrencyType.USD), "A delicious apple", DateTime.Now.AddDays(7));
		//Product product4 = new FoodProduct("Banana", new Money(2, CurrencyType.USD), "A delicious banana", DateTime.Now.AddDays(5));
		...
		Money m1 = new Money(10, CurrencyType.USD);
		Money m2 = new Money(5, 25, CurrencyType.USD);
